    ...
    <div class="grid-container">
        ...
        <div class="main main-leftClass">
            <div class=''>
                <div class=''>
                    <!--TWEET WRAPPER-->
                    <p class="page_title mb-0"><a style="cursor: pointer" href="home.php"><i class="fa fa-arrow-left mr-4" style="color:#50b7f5;"></i></a><?php echo $profileData->username; ?></p>
                    <div class='profile-box'>
                        <div class='profile-cover mt-0'>
                            <!-- PROFILE-IMAGE -->
                            <img src="<?php echo BASE_URL.'views/'.$profileData->profileCover; ?>" />
                        </div>
                        <div class='profile-body'>
                            <div class="profile-header">
                                <div class="profile-image">
                                    <img src="<?php echo BASE_URL.'views/'.$profileData->profileImage; ?>" />
                                </div>
                                ...
                                <div class="profile-link d-flex mt-3">
                                    <?php if(!empty($profileData->website)){ ?>
                                        <h6><i class="fa fa-link mr-2"></i><a class="mr-4" href="<?php echo '../../../'.$profileData->website; ?>" target="_blank" style="color:rgba(29,161,242,1.00);">
                                            ...
                                            <div class="date-text" style="display: flex; align-items:center; text-align:center;">
                                                <img class="datee" src="users/date.png" style="width: 7%;margin-right: 5px;">
                                                <p style="color: #777; margin-bottom: 0px;">Joined <?php echo $getFromU->getDate($user_id) ?></p>
                                            </div>
                                            <div class="profile-follow mt-2 d-flex">
                                                <h6 class="mr-3 ml-1" style="font-weight: 700;"><?php echo $profileData->following; ?>
                                                <a href="following.php?username=<?php echo $profileData->username; ?>">
                                                    <a href="following.php?username=<?php echo $profileData->username; ?>" style="color:rgb(91, 112, 131);">Following</a>
                                                </a></h6>
                                                <h6 class="mr-3"style="font-weight: 700;"><?php echo $profileData->followers; ?>
                                                <a href="followers.php?username=<?php echo $profileData->username; ?>"style="color:rgb(91, 112, 131);">
                                                    Followers
                                                </a></h6>
