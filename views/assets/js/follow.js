$(function(){
  $('.follow-btn').click(function(){
    ...
    if ($button.hasClass('following-btn')) {
      $.post('http://localhost/twitter/controller/ajax/follow.php', {unfollow:followID, profile:profile}, function(data){
      ...
      $.post('http://localhost/twitter/controller/ajax/follow.php', {follow:followID, profile:profile}, function(data){
        data = JSON.parse(data);
