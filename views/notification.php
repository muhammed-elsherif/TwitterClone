...
<body>
    <div class="grid-container">
        ...
        <script type="text/javascript" src="<?php echo BASE_URL;?>views/assets/js/like.js"></script>
        <script type="text/javascript" src="<?php echo BASE_URL;?>views/assets/js/retweet.js"></script>
...
<!--                <div class="in-center-wrap">-->
                    ...
                    <div class="notification-full-wrapper">
                            ...
                            <div class="notification-inner">
                                <div class="notification-header">
                                    ...
                                    <div class="notification-name">
                                        <div>
                                            <img src="<?php echo BASE_URL.'views/'.$data->profileImage;?>" />
                                        </div>
                        ...
                        <div class="notification-wrapper">
                            <div class="notification-inner">
                                ...
                                <div class="notification-tweet">
                                    <a href="<?php echo BASE_URL.'views/'.$data->profileImage;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> liked your <?php if($data->tweetBy === $user_id){echo 'Tweet';}else{echo 'Retweet';}?> - <span><?php echo $getFromU->timeAgo($data->time);?></span>
                                </div>
                                <div class="notification-footer">
                                    <div class="noti-footer-inner">
                                        ...
                                        <div class="noti-footer-inner-right">
                                            <img src="<?php echo BASE_URL.'views/'.$data->tweetImage;?>" />
                                        </div>
                                        <?php endif;?>
							...
							<div class="t-show-popup" data-tweet="'.$tweet->tweetID.'" data-user="'.$tweet->tweetBy.'">
								<div class="t-show-head">
									<div class="t-show-img">
										<img src="'.BASE_URL.'views/'.$tweet->profileImage.'"/>
									</div>
					       ...
					       '<div class="t-show-body">
								  <div class="t-s-b-inner">
									   <div class="t-s-b-inner-in">
									     <img src="'.BASE_URL.'views'.$tweet->tweetImage.'" class="imagePopup" data-tweet="'.$tweet->tweetID.'" data-user="'.$tweet->tweetBy.'"/>
									   </div>
								  </div>	
							   </div>' : '' ) .'
			...
			?>
                    ...
                    <!--Tweet END WRAPER-->
                    <script type="text/javascript" src="views/assets/js/popuptweets.js"></script>
                    <script type="text/javascript" src="views/assets/js/hashtag.js"></script>
                    <script type="text/javascript" src="views/assets/js/delete.js"></script>
                    <script type="text/javascript" src="views/assets/js/popupForm.js"></script>
                    <script type="text/javascript" src="views/assets/js/messages.js"></script>
                    <script type="text/javascript" src="views/assets/js/postMessage.js"></script>
                    <script type="text/javascript" src="views/assets/js/notification.js"></script>
                    <script type="text/javascript" src="views/assets/js/main.js"></script>
                </div><!-- in left wrap-->
<!--            </div> in center end -->
<!--        </div>-->

        <script type='<?php echo BASE_URL;?>text/javascript' src='views/assets/js/search.js'></script>
        <script type='<?php echo BASE_URL;?>text/javascript' src='views/assets/js/hashtag.js'></script>

        <?php require 'right-sidebar.php' ?>

        <script type='text/javascript' src='views/assets/js/follow.js'></script>
