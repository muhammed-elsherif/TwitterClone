<?php 
	...
	if(isset($_FILES['removeProfileImage'])){
		if(!empty($_FILES['removeProfileImage']['name'][0])){
			$fileRoot  = $getFromU->uploadImage($_FILES['profileImage']);
			$getFromU->update('users', $user_id, array('profileImage' => $fileRoot));
			header('Location: profileEdit.php');
		}
        ...
        <div class="main main-leftClass">
            ...
            <div class='profile-box'>
                <div class='profile-cover mt-0'>
                    <!-- PROFILE-IMAGE -->
                    <img src="<?php echo BASE_URL.'views/'.$user->profileCover; ?>" />
...
-->
                                    ...
                                    <div class="img-upload-menu">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <ul>
                                                ...
                                                <li><label for="removeProfileImage">Remove</label></li>
                                                <li>
                                                    <label for="img-upload-btn">
                                                        Cancel
                                                    </label>
                        ...
                        <div class="edit-button d-flex">
                            <span>
                                <button class="new-btn mr-3" type="button" onclick="window.location.href='<?php echo BASE_URL; ?>views/profile.php?username=<?php echo $user->username; ?>'" value="Cancel" style="outline:none;">Cancel</button>
                            </span>
                            <span>
                                <button class="new-btn mr-3" id="save" type="button" value="Save-Changes" style="outline:none;">Save</button>
                            </span>
                        </div>
                    </div>
